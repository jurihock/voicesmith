...
open class AudioPluginFactory {
  ...
  external fun voicesmith_plugin_setup(input: Int, output: Int, samplerate: Int, buffersize: Int, pointer: JnaPointerByReference, result: JnaResultByReference) : Boolean
