...
#include <jni.h>
/* Header for class de_jurihock_voicesmith_dsp_dafx_NativeResampleProcessor */

#ifndef _Included_de_jurihock_voicesmith_dsp_dafx_NativeResampleProcessor
#define _Included_de_jurihock_voicesmith_dsp_dafx_NativeResampleProcessor
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     de_jurihock_voicesmith_dsp_dafx_NativeResampleProcessor
 * Method:    alloc
 * Signature: (II)J
 */
